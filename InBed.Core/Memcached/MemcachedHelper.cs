...
namespace InBed.Core.Memcached
{
    ...
    public class MemcachedHelper
    {
        ...
        #region 获取缓存数据(Cookie)
        /// <summary>
        /// 获取在线用户
        /// </summary>
        /// <param name="userData"></param>
        /// <returns></returns>
        public static string GetOnlineUserid(string userData)
        {
        ...
        /// <param name="userData"></param>
        /// <returns></returns>
        public static string GetOnlineFacilitatorName(string userData)
        {
            string[] UserData = userData.Split('#');
            if (UserData.Length != 0)
            {
        ...
        /// <param name="userData"></param>
        /// <returns></returns>
        public static string GetOnlineFacilitatorCode(string userData)
        {
            string[] UserData = userData.Split('#');
            if (UserData.Length != 0)
            {
