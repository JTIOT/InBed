...
namespace InBed.Data
{
    ...
    public class InBedContext : DbContext
    {
        /// <summary>
        /// InBedContext
        /// </summary>
        public InBedContext() : base("InBed")
        {
            //SQL语句拦截器
        ...
        public InBedContext(string connectionString) : base(connectionString)
        {
        }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new FacilitatorConfig());
