...
namespace InBed.Data
{
    ...
    /// 数据库初始化
    /// </summary>
    internal sealed class Configuration : DbMigrationsConfiguration<InBedContext>
    {
        private readonly DateTime now = new DateTime(2017, 5, 1, 23, 22, 21);
        ...
        protected override void Seed(InBedContext context)
        {
            #region 用户
            ...
            var admin = new UserEntity
            {
                ...
                Email = "service@InBed.com",
                Status = 2,
                CreateDateTime = now,
                Creater = 0,
                FacilitatorCode = "F_0001",
                FacilitatorName = "上海上源物联网科技有限公司",
                IsDeleted = false
